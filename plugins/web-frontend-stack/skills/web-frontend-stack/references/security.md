...
Security best practices for Astro + React/Preact applications. Most security is handled at the Astro/server level, but React components need awareness too.
