...
Testing strategy for Astro + React/Preact applications with Bun, Vitest, Testing Library, and Playwright.
...
5. **Mock at the network level** — Use MSW, not module mocks
6. **Test critical paths E2E** — Login, checkout, key features
