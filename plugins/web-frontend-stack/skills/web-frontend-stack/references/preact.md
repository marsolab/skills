...
2. **Use .value sparingly** — Let JSX auto-subscribe
3. **Computed for derived state** — Don't duplicate in signals
4. **Test with preact/compat** — Before removing compat
5. **Check library compatibility** — Before adopting Preact
6. **Use onInput for text inputs** — More consistent than onChange
7. **Profile before optimizing** — Signals aren't always needed
