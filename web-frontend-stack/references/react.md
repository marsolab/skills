...
React powers interactive islands within Astro pages. Use React for complex UI components, especially when using Shadcn UI. For simple islands where bundle size matters, consider Preact.
