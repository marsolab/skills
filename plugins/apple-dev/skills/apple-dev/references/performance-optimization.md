...
1. Optimize for the common case, not edge cases
1. Use lazy evaluation where appropriate
1. Prefer value types (structs) over reference types (classes)
1. Minimize work on the main thread
1. Cache expensive computations
1. Use appropriate data structures
1. Release resources when not needed
1. Test on actual devices, not just simulators
1. Monitor production performance with MetricKit
